...
# # a6 = 0 #0~0.96
num = 0
city_path = '/remote-home/share/Cityscapes/leftImg8bit/val_front/'
...
for i in city_dir:
    ...
    for j in subdir:
        ...
        if(proportion>0.99):
            a1+=1
            new_img_dir = '/remote-home/share/42/cyc19307140030/CVPR/BFNet/FoggyCityscapes_dif_back/0.99_1/images/' + i
            new_lb_dir = '/remote-home/share/42/cyc19307140030/CVPR/BFNet/FoggyCityscapes_dif_back/0.99_1/labels/' + i
        elif(proportion>0.96):
            a2+=1
            new_img_dir = '/remote-home/share/42/cyc19307140030/CVPR/BFNet/FoggyCityscapes_dif_back/0.96_0.99/images/' + i
            new_lb_dir = '/remote-home/share/42/cyc19307140030/CVPR/BFNet/FoggyCityscapes_dif_back/0.96_0.99/labels/' + i
        else:
            a3+=1
            new_img_dir = '/remote-home/share/42/cyc19307140030/CVPR/BFNet/FoggyCityscapes_dif_back/0_0.96/images/' + i
            new_lb_dir = '/remote-home/share/42/cyc19307140030/CVPR/BFNet/FoggyCityscapes_dif_back/0_0.96/labels/' + i
