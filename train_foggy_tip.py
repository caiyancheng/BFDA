...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/foggycity.yaml', help='data.yaml path')#数据集目录
    ...
    parser.add_argument('--project', default='runs/train_tip_foggycityscapes_2048_mosaic', help='save to project/name')
