...
def train(hyp, opt, device, tb_writer=None,MR=False,if_SAM=False):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/foggy_allclass.yaml', help='data.yaml path')#数据集目录
    ...
    parser.add_argument('--project', default='runs/train_tip_foggycityscapes_2048_mosaic_allclass', help='save to project/name')
