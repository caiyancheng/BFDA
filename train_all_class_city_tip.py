...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/city_allclass.yaml', help='data.yaml path')#数据集目录
    ...
    parser.add_argument('--project', default='runs/train_tip_cityscapes_2048_mosaic_allclass', help='save to project/name')
