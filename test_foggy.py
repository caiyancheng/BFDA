...
if __name__ == '__main__':
    ...
    #                     help='model.pt path(s)')
    parser.add_argument('--weights', nargs='+', type=str,
                        default='./runs/train_tip_foggycityscapes_2048_mosaic/exp3/weights/best.pt',
                        help='model.pt path(s)')
    # parser.add_argument('--weights', nargs='+', type=str,
    ...
    #                     help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='data/foggycity.yaml', help='*.data path')#citytocaltech#cityperson#citytobdd_day#foggycity
