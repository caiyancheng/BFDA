...
Pseudo_Label_Value = -1 #-1#0#1#Random
print('Pseudo_Label_Value:' , Pseudo_Label_Value)
...
###########################################################下面就是按照iter计数
        ...
        for i, (src,dis_src,dis_trg) in pbar:#源域和目标域
            ...
            src_back_cycle = paste_label_value(imgs=imgs_src.clone(), real_labels=real_labels_src, pseudo_label_value=Pseudo_Label_Value)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=30)#几个epoch?
    ...
    parser.add_argument('--project', default='runs/UDA_city2caltech_BFDA_Full_pseudo_label', help='save to project/name')
