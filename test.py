...
def test(data,
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        with torch.no_grad():
            ...
            #     if paths[NUM_i].split('/')[-1] == 'set07_V000_179.png':
            #         W = 1
            #         print("find it")
            #         continue
            if vision_show_feature and W:#paths[0].split('/')[-1] == 'frankfurt_000001_013016_leftImg8bit.png': #and paths[0].split('/')[-1] == 'set07_V000_179.png':
                ...
                for i in range(ir):
                    ...
                    img = cv2.imread("/remote-home/share/Caltech/images/test_debug/set07/set07_V000_179.png")
                    ...
                    ax.plot_surface(x, y, np.atleast_2d(Z.min()), rstride=2, cstride=2, facecolors=img)
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--weights', nargs='+', type=str,
    #                     default='./runs/train_forpaper/exp62/weights/best_mr.pt', #28
    #                     help='model.pt path(s)')
    # parser.add_argument('--weights', nargs='+', type=str, default='./runs/trainforpaper_crossdomain_transformer/exp32/weights/best_mr.pt', help='model.pt path(s)')
    # parser.add_argument('--weights', nargs='+', type=str,
