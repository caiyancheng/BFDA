...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str,
                        default='./runs/train_forpaper_all_class/exp2/weights/best.pt',
                        help='model.pt path(s)')
    # parser.add_argument('--weights', nargs='+', type=str,
    #                     default='./runs/trainforpaper_cycle_allclass/exp/weights/best_map.pt',
    #                     help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='data/foggy_allclass.yaml', help='*.data path')#citytocaltech#cityperson#citytobdd_day#foggycity
